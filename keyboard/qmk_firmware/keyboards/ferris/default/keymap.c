...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x5_2(
        KC_TAB, KC_PMNS, KC_EQL, KC_GT, KC_LT,          KC_DOWN, KC_RIGHT, KC_AMPR, KC_BSPC, KC_DEL,
        KC_COLN, KC_LBRC, KC_LPRN, KC_LCBR, KC_PERC,    KC_GRV, KC_RCBR, KC_RPRN, KC_RBRC, KC_ENTER, 
        KC_SLSH, KC_UNDS, KC_PLUS, KC_BSLS, KC_AT,      KC_UP, KC_LEFT, KC_CIRC, KC_DLR, KC_QUES, 
        KC_NO, KC_NO,                                   KC_SPC, KC_NO
    ),
    [2] = LAYOUT_split_3x5_2(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,             KC_NO, KC_NO, KC_6, KC_NO, KC_NO, 
        KC_4,  KC_3,  KC_2,  KC_1,  KC_NO,             KC_NO, KC_0,  KC_7,  KC_8,  KC_9, 
        KC_NO, KC_NO, KC_NO, KC_5,  KC_NO,             KC_NO, KC_6, KC_NO, KC_NO, KC_NO, 
        KC_NO, KC_NO,                                  KC_SPC, KC_NO
    ),
